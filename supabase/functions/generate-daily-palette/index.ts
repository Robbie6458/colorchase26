...
serve(async (req) => {
  ...
  try {
    ...
    const SCHEME_EXPLANATIONS: Record<string, { title: string; description: string; colorTheory: string }> = {
      complementary: {
        title: 'Complementary',
        description: 'Colors opposite each other on the color wheel.',
        colorTheory: 'Complementary colors create maximum contrast and visual tension.',
      },
      triadic: {
        title: 'Triadic',
        description: 'Three colors evenly spaced around the color wheel.',
        colorTheory: 'Triadic schemes offer vibrant, balanced palettes with rich visual contrast.',
      },
      analogous: {
        title: 'Analogous',
        description: 'Colors that sit next to each other on the wheel.',
        colorTheory: 'Analogous palettes are harmonious and pleasing to the eye.',
      },
      'split-complementary': {
        title: 'Split-Complementary',
        description: 'A base color plus the two adjacent to its complement.',
        colorTheory: 'This scheme offers strong visual contrast with more nuance.',
      },
      tetradic: {
        title: 'Tetradic (Double-Complementary)',
        description: 'Two pairs of complementary colors.',
        colorTheory: 'Tetradic schemes are rich and complex, offering plenty of color variety.',
      },
      square: {
        title: 'Square',
        description: 'Four colors evenly spaced around the wheel.',
        colorTheory: 'Square schemes provide perfect balance with four distinct colors.',
      },
      rectangular: {
        title: 'Rectangular (Tetradic Rectangle)',
        description: 'Two complementary pairs with unequal spacing.',
        colorTheory: 'Similar to square but with varied spacing, offering more flexibility.',
      },
      accent: {
        title: 'Accent',
        description: 'A dominant color with strategic accent colors.',
        colorTheory: 'Accent schemes use a primary color family with contrasting colors for emphasis.',
      },
    };
    ...
    // ============================================
    const metadata = generatePaletteName(wheelData.familyKey, scheme, today);
      ...
      .insert([
        {
          ...
          palette_name: metadata.name,
          palette_description: metadata.description,
          best_used_for: metadata.bestUsedFor,
        },
      ])
      .select();
